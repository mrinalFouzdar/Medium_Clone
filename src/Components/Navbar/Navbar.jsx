...
border-bottom:${props=>(props.color==="rgb(68, 121, 255)") ? "1px solid white": "1px solid black"} ;
...
const StyledLink = styled(Link)`
  ...
  font-family: 'Soehne web buch', sans-serif;
    /* color: rgb(0 0 0); */
    color:${props=>(props.color==="rgb(68, 121, 255)") ? "white": "rgb(0 0 0)"};
    font-size: 15px;
    line-height: 100%;
  ...
  return (
    ...
    <Nav color={color}>
        <div className='fDiv'>
          ...
          <StyledLink to="/"><svg class="svgIcon-use" height="25" viewBox="0 0 3940 610">
          ...
          <div className='sDiv'>
            <div className='childDiv'>
                 <StyledLink to="/ourStory"  color={color}>Our Story</StyledLink>
            </div>
            <div  className='childDiv'>
                <StyledLink to="/memberShip" color={color}>Membership</StyledLink>
            </div>

            <div className='childDiv'>
                <StyledLink to="/write" color={color}>Write</StyledLink>
            </div>
            <div className='childDiv'>
               <StyledLink to="/logIn" color={color}>Sign In</StyledLink>
            </div>
            <div className='childLast'>
               <StyledLinklast to="/StartIn" color={color}>Start Writing</StyledLinklast>
            </div>
        </div>
    </Nav>
    </>
